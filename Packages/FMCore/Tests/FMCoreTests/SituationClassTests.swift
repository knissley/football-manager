...
struct SituationClassTests {
    ...
    @Test("Distance buckets split at three and seven yards")
    ...
    @Test("First down is a single bucket regardless of distance")
    ...
    @Test("Goal-to-go outranks the distance bucket on every down")
    func goalToGoWins() {
    ...
    @Test("Last down, passing down and short yardage read as the sport does")
    func downPredicates() {
    ...
    @Test("Score buckets split where the possession count changes")
    func scoreBuckets() {
    ...
    @Test("Trailing, leading and one-score are consistent with the buckets")
    ...
    @Test("The same scoreboard mirrors when possession changes")
    ...
    @Test("Time buckets follow the quarter and the stoppages that matter")
    func timeBuckets() {
    ...
    @Test("Two-minute and endgame are different things")
    func timePredicates() {
    ...
    @Test("Distance alone makes a passing down obvious")
    ...
    @Test("The clock forces the throw when trailing late")
    ...
    @Test("Tied and late is a must-pass only outside your own end")
    ...
    @Test("Clock burn is the leading team's version of the same moment")
    func clockBurn() {
    ...
    @Test("Desperation is trailing with a half running out")
    func desperation() {
    ...
    @Test("Fourth-down territory is short yardage, or late and behind")
    ...
    @Test("Field goal range starts at the opponent's forty-nine")
    func fieldGoalRange() {
    ...
    @Test("Defensive leverage covers get-off downs, the red zone and late close games")
    ...
    @Test("One classification per snap serves both sidelines")
    ...
    /// share instead.
    @Test("Flipping only the scoreboard flips which read fires")
    ...
    @Test("Classification depends only on the fields it reads")
    ...
    /// silently never fire.
    @Test("Every down-and-distance bucket is reachable")
