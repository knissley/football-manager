...
| yards per carry, outnumbered by one | 3.9-5.1 | 2023-24 | — | S2 | yes | Same construction, one more in the box than blockers. The sport's gap between even and outnumbered is small: 4.3–4.6 against 4.5–4.7. The source plays this box on 11.1–12.7% of first-and-ten designed carries. Before #218 the engine reached it on 0.2% and the row read n/a for want of a sample; with the package drawn from the source's conditional it reaches it on 9.7% — 1,175 carries at seed 7 — and grades, at 3.1. The level is [#227](https://github.com/knissley/football-manager/issues/227)'s. |
