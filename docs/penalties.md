...
- **The previous spot.** Every foul before the snap (14-4-1); the offence's fouls at
  ...
  one of the acts that conserve time, so inside two minutes it carries the runoff
  (4-7-1-b).
...
the 6 after a run gives the 3. It is a ceiling on every walk-off and not only on one that
would reach the goal line, so it bites well short of it: fifteen yards from the 20 is more
than half of twenty, and a contact foul in the red zone is first and goal at the 10 rather
than the 5. Measuring every foul from the previous spot, as the engine
